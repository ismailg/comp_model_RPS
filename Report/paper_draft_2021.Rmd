...
abstract: |
  ...
  this transfer is moderated by the level of sophistication of the opponent (second experiment), as well as the similarity between games**. Computational modelling shows that players start each game with a model-based
...
**MS: What do these effects indicate? Report post-hoc comparisons between games, and e.g. differences between opponents for each game, here. The later tests against 0 are not adequate to understand the effects here.**
...
**MS: why is there a superscript in $h^k$ and $r^k$? ** 
**IG : Because they depend on opponent action k** 

**MS: And is the indicator variable $I(o^k = o_{t})$?**
**IG: Yes, corrected**

**And is $\delta_a(t)$ always 0 or 1?**
**IG: yes. Pls refer to: Camerer, C. F., & Ho, T. H. (2015). Behavioral game theory experiments and modeling. Handbook of game theory with economic applications, 4, 517-573.**
