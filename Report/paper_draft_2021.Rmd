...
For more details on the self-tuning EWA model, we refer the reader to [@ho2004economics].As in the models above, actions are chosen based on a softmax decision rule:
...
**MS: Please present the models in the figures in the order mentioned in text (i.e., Nash, RL, EWA, BCH), and when providing versions of each, do so in the same order as well, i.e. x_NT, x_WT, x_BT.  IG : DONE **
