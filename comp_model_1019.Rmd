...
BIC_weights <- comp_BICs["ID"]
BIC_weights[,2:ncol(comp_BICs)] <- t(apply(comp_BICs[,2:ncol(comp_BICs)], 1, function(i) exp(-0.5*(i-min(i)) )))
colnames(BIC_weights) <-colnames(comp_BICs)

BIC_weights[,2:ncol(BIC_weights)] <- t(apply(BIC_weights[,-1], 1, function(i) round(i/sum(i),2)))
