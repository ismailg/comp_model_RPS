...
Bayes_model_LL <- function(par,data,distinct_opponent = TRUE, generalize = c("game","stage","no"), return = "-2loglik"){
...
```{r}
Bayes_model_LL(0.5,data = dat,distinct_opponent = TRUE, generalize = "game", return = "likelihood_by_trial")
