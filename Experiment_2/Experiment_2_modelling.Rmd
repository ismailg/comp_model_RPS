...
exp2_table_results <- table(exp2_results[, "condition"],c("random","TOM_BT","TOM_NBT", "TOM_NT", "QL_states","QLS_within","STEWA_NT","STEWA_Tr")[apply(exp2_results[,c("Random_BIC","Distinct_game_BIC","Distinct_stage_BIC","Bayes_distinct_no","QL_states_BIC","QLS_within_Tr_BIC","STEWA_NT_BIC","STEWA_Tr_BIC")],1,which.min)])
...
for(id in unique(dat_exp2$human_id)) {
  ...
  best_model <- c("random","TOM_BT","TOM_NBT", "TOM_NT", "QL_states","QLS_within","STEWA_NT","STEWA_Tr")[apply(id_results[,c("Random_BIC","Distinct_game_BIC","Distinct_stage_BIC","Bayes_distinct_no","QL_states_BIC","QLS_within_Tr_BIC","STEWA_NT_BIC","STEWA_Tr_BIC")],1,which.min)]
